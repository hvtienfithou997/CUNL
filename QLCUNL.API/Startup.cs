                ...
                options.Events = new JwtBearerEvents
                {
                    ...
                    OnAuthenticationFailed = context =>
                    {
                        if (context.Exception.GetType() == typeof(SecurityTokenExpiredException))
                        {
                            ...
                            {
                                var new_role = QLCUNL.BL.UserBL.GetRoles(jwt.Payload["nameid"].ToString());
                                token = TokenManager.BuildToken(jwt.Payload["app_id"].ToString(), jwt.Payload["nameid"].ToString(), new_role, jwt.Payload["given_name"].ToString(), jwt.Payload["team"].ToString(), jwt.Payload["ipad"].ToString());

...
function onShowThuocTinh(id) {
    ...
    callAPI(`${API_URL}/thuoctinh/canhan?loai=2&id=${id}`, null, "GET", function (res) {
        if (res.success) {
            console.log(res)
            let thuoc_tinh = '';
            ...
            $('#thuoc_tinh_du_lieu').append(`<a target='_blank' href="/thuoctinh/add?loai=2"><i class="icon-add"></i>Thêm thuộc tính</a>`);
        }
    });
}

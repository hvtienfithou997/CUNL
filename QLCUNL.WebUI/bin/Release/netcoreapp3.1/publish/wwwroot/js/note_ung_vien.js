    ...
    callAPI(`${API_URL}/NoteUngVien/view?id=${id}`, null, "GET", function (res) {
        if (res.success) {
            if (res.data != null && res.data != undefined && res.data != "") {
                ...
                //$("#noteungvien_detail").append(`<li>ID :<span class="font-weight-bold">${res.data.id_note_ung_vien}</span></li>`);
                ...
                $("#noteungvien_detail").append(`<li>Ngày sửa :<span class="font-weight-bold">${epochToTime(res.data.ngay_sua)}</span></li>`);

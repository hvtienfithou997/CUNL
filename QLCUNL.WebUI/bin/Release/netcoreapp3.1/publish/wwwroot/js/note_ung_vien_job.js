    ...
    callAPI(`${API_URL}/NoteUngVienJob/view?id=${id}`, null, "GET", function (res) {
        if (res.success) {
            if (res.data != null && res.data != undefined && res.data != "") {
                ...
                $("#note_ung_vien_job_detail").append(`<li>Ứng viên:  <span class="font-weight-bold">${res.data.ho_ten_ung_vien}</span></li>`);
                ...
                $("#note_ung_vien_job_detail").append(`<li>JOB:  <span class="font-weight-bold"></span></li>`);

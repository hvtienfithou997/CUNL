...
function search1() {
    ...
    console.log(thuoc_tinh_string + ' ' + thuoc_tinh_rieng_string);
    let term = $('#term1').val();
    ...
    if ($('#ngay_di_lam_from1').val() != "") {
        ngay_di_lam_from = Math.floor(new Date($('#ngay_di_lam_from1').val()) / 1000.0);
    }
    if ($('#ngay_di_lam_to1').val() != "") {
        ngay_di_lam_to = Math.floor(new Date($('#ngay_di_lam_to1').val()) / 1000.0);
    }
    if ($('#ngay_tao_from1').val() != "") {
        ngay_tao_from = Math.floor(new Date($('#ngay_tao_from1').val()) / 1000.0);
    }

    if ($('#ngay_tao_to1').val() != "") {
        ngay_tao_to = Math.floor(new Date($('#ngay_tao_to1').val()) / 1000.0);
    }
